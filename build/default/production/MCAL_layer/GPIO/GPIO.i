...
# 1 "MCAL_layer/GPIO/GPIO_Config.h" 1
# 15 "MCAL_layer/GPIO/GPIO.h" 2
# 47 "MCAL_layer/GPIO/GPIO.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *pin_config){
    ...
    if(pin_config == ((void*)0) || pin_config->pin > 8 -1 || pin_config->port > 5 -1){
        ...
        ((*((volatile uint8 *)(tris_registers[pin_config->port]))) &= (~(0x01 << pin_config->pin)));
...
# 48 "MCAL_layer/GPIO/GPIO.c"
Std_ReturnType gpio_pin_get_direction_status( pin_config_t *pin_config, direction_t *direction_status){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(pin_config == ((void*)0) || direction_status == ((void*)0)){
        ret =(Std_ReturnType)0x01;
    }
    else{
        *direction_status = ((((*((volatile uint8 *)(tris_registers[pin_config->port]))) >> pin_config->pin) & 0x01));
...
Std_ReturnType gpio_pin_write_logic( pin_config_t *pin_config, logic_t logic){
    ...
    if(pin_config == ((void*)0)){
        ...
        switch(logic){
            case GPIO_HIGH:
                ((*((volatile uint8 *)(lat_registers[pin_config->port]))) |= (0x01 << pin_config->pin));
...
# 112 "MCAL_layer/GPIO/GPIO.c"
Std_ReturnType gpio_pin_read_logic( pin_config_t *pin_config, logic_t *logic){

    Std_ReturnType ret = (Std_ReturnType)0x00;

    if(pin_config == ((void*)0) || logic == ((void*)0)){
        ret =(Std_ReturnType)0x01;
    }
    else{
        *logic = ((((*((volatile uint8 *)(port_registers[pin_config->port]))) >> pin_config->pin) & 0x01));
        pin_config->logic = *logic;
    }
    return ret;

}
# 136 "MCAL_layer/GPIO/GPIO.c"
...
Std_ReturnType gpio_port_direction_initialize(port_index_t port, uint8 direction){
    ...
    if(port > 5 -1){
        ...
        (*((volatile uint8 *)(tris_registers[port]))) = direction;
    }
    return ret;
...
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status){
    ...
    if(direction_status == ((void*)0) || port > 5 -1){
        ...
        *direction_status = (*((volatile uint8 *)(tris_registers[port]))) ;
    }
    return ret;

}
# 234 "MCAL_layer/GPIO/GPIO.c"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic){
    ...
    if(port > 5 -1){
        ...
        (*((volatile uint8 *)(lat_registers[port]))) = logic;
    }

    return ret;

}
# 259 "MCAL_layer/GPIO/GPIO.c"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic){
    ...
    if(logic == ((void*)0) || port > 5 -1){
        ...
        *logic = (*((volatile uint8 *)(lat_registers[port]))) ;
    }
    return ret;

}
# 282 "MCAL_layer/GPIO/GPIO.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
    ...
    if(port > 5 -1){
        ret =(Std_ReturnType)0x01;
         ...
         (*((volatile uint8 *)(lat_registers[port]))) ^= 0xFF;
    }
...
Std_ReturnType gpio_port_low_nibble_direction_initialize(pin_config_t *pin_config, uint8 data){
    ...
    if(pin_config == ((void*)0)){
        ...
        ((*((volatile uint8 *)(tris_registers[pin_config->port]))) = (((*((volatile uint8 *)(tris_registers[pin_config->port])))&0xF0)|(data&0x0F)));
    }
    return ret;
...
Std_ReturnType gpio_port_low_nibble_write_logic(pin_config_t *pin_config, uint8 data){
    ...
    if(pin_config == ((void*)0)){
        ...
        ((*((volatile uint8 *)(lat_registers[pin_config->port]))) = (((*((volatile uint8 *)(lat_registers[pin_config->port])))&0xF0)|(data&0x0F)));
    }
    return ret;
}
Std_ReturnType gpio_port_high_nibble_direction_initialize(pin_config_t *pin_config, uint8 data){
    ...
    if(pin_config == ((void*)0)){
        ...
        ((*((volatile uint8 *)(tris_registers[pin_config->port]))) = (((*((volatile uint8 *)(tris_registers[pin_config->port])))&0x0F)|(data&0xF0)));
    }
    return ret;
...
Std_ReturnType gpio_port_high_nibble_write_logic(pin_config_t *pin_config, uint8 data){
    ...
    if(pin_config == ((void*)0)){
        ...
        ((*((volatile uint8 *)(lat_registers[pin_config->port]))) = (((*((volatile uint8 *)(lat_registers[pin_config->port])))&0x0F)|(data&0xF0)));
    }
    return ret;
